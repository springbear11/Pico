...
std::string commandFor(MeasurementMode mode, double range, double resolution)
{
    ...
    // 34410A: CONF <mode>[,<range>[,<resolution>]] - resolution is the display
    // step (0.0001~10, dependent on range). 0 means "do not set".
...
Result Keysight34410AAdapter::configure(MeasurementMode mode, double range, double integration, double resolution)
{
