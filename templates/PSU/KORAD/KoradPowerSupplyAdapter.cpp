    ...
    return Plugin::Json::parse(R"json(
{
  ...
  "functions": [
    ...
    {"id":"setCurrent","name":"Set Current","description":"Send ISET<X>:<NR2>","timeoutMs":2000,"inputs":[{"key":"channel","name":"Channel","type":"enum","required":false,"default":1,"options":[{"label":"CH1","value":1},{"label":"CH2","value":2},{"label":"CH3","value":3}]},{"key":"current","name":"Current","type":"number","required":true,"default":1.0,"minimum":0.0,"unit":"A"}],"outputs":[{"key":"current","name":"Current","type":"number","unit":"A"}]},
    {"id":"getCurrentSetpoint","name":"Read Current Setpoint","description":"Send ISET<X>?","timeoutMs":2000,"inputs":[{"key":"channel","name":"Channel","type":"enum","required":false,"default":1,"options":[{"label":"CH1","value":1},{"label":"CH2","value":2},{"label":"CH3","value":3}]}],"outputs":[{"key":"current","name":"Current Setpoint","type":"number","unit":"A"}]},
    {"id":"setVoltage","name":"Set Voltage","description":"Send VSET<X>:<NR2>","timeoutMs":2000,"inputs":[{"key":"channel","name":"Channel","type":"enum","required":false,"default":1,"options":[{"label":"CH1","value":1},{"label":"CH2","value":2},{"label":"CH3","value":3}]},{"key":"voltage","name":"Voltage","type":"number","required":true,"default":5.0,"minimum":0.0,"unit":"V"}],"outputs":[{"key":"voltage","name":"Voltage","type":"number","unit":"V"}]},
    {"id":"getVoltageSetpoint","name":"Read Voltage Setpoint","description":"Send VSET<X>?","timeoutMs":2000,"inputs":[{"key":"channel","name":"Channel","type":"enum","required":false,"default":1,"options":[{"label":"CH1","value":1},{"label":"CH2","value":2},{"label":"CH3","value":3}]}],"outputs":[{"key":"voltage","name":"Voltage Setpoint","type":"number","unit":"V"}]},
    {"id":"measureCurrent","name":"Measure Output Current","description":"Send IOUT<X>?","timeoutMs":2000,"inputs":[{"key":"channel","name":"Channel","type":"enum","required":false,"default":1,"options":[{"label":"CH1","value":1},{"label":"CH2","value":2},{"label":"CH3","value":3}]}],"outputs":[{"key":"current","name":"Output Current","type":"number","unit":"A"}]},
    {"id":"measureVoltage","name":"Measure Output Voltage","description":"Send VOUT<X>?","timeoutMs":2000,"inputs":[{"key":"channel","name":"Channel","type":"enum","required":false,"default":1,"options":[{"label":"CH1","value":1},{"label":"CH2","value":2},{"label":"CH3","value":3}]}],"outputs":[{"key":"voltage","name":"Output Voltage","type":"number","unit":"V"}]},
    ...
    {"id":"recall","name":"Recall Preset","description":"Send RCL<NR1>","timeoutMs":2000,"inputs":[{"key":"slot","name":"Memory Slot","type":"enum","required":true,"default":1,"options":[{"label":"Slot 1","value":1},{"label":"Slot 2","value":2},{"label":"Slot 3","value":3},{"label":"Slot 4","value":4},{"label":"Slot 5","value":5}]}],"outputs":[{"key":"slot","name":"Memory Slot","type":"integer"}]},
    {"id":"save","name":"Save Preset","description":"Send SAV<NR1>","timeoutMs":2000,"inputs":[{"key":"slot","name":"Memory Slot","type":"enum","required":true,"default":1,"options":[{"label":"Slot 1","value":1},{"label":"Slot 2","value":2},{"label":"Slot 3","value":3},{"label":"Slot 4","value":4},{"label":"Slot 5","value":5}]}],"outputs":[{"key":"slot","name":"Memory Slot","type":"integer"}]},
